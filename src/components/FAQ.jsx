  ...
  return (
    <Slide direction="left">
      <Fade duration={1000}>
        ...
        <div className="grid gap-3 w-10/11 lg:w-[70%] mx-auto my-10">
          <Accordion
          ...
          />
          <Accordion
            Q={"How much does MealMind cost?"}
            A={
              "MealMind is 100% Free OpenSource Recipe Book, means you don't have to pay anything. Just create an account and you are good to go."
            }
          />
          <Accordion
