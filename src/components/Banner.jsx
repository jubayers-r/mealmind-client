...
const Banner = () => {
  return (
    <Slide direction="left">
      <Fade duration={1000}>
        <section className="bg-gray-900 text-white py-16 px-6 md:px-12 lg:px-24 my-20 rounded-4xl w-10/11 mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-2xl sm:text-4xl  font-bold mb-4 font-[Playwrite_HU]">
                Your ultimate go to restaurant.
              </h2>
              <p className="text-lg mb-6">
                Tried, tested & loved by thousands of home freaks. MealMind is
                free to use
              ...
              <Link to={"/signin"}>
                <button
                  href="/get-started"
                  className="btn hover:bg-[#00ed64] hover:rounded-full hover:border hover:border-black btn-lg flex w-fit my-3"
                >
                  GET STARTED
                </button>
              </Link>
